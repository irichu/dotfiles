...
# select session
alias s0='tmux select-session -t 0'
alias s1='tmux select-session -t 1'
alias s2='tmux select-session -t 2'
alias s3='tmux select-session -t 3'
alias s4='tmux select-session -t 4'
alias s5='tmux select-session -t 5'
alias s6='tmux select-session -t 6'
alias s7='tmux select-session -t 7'
alias s8='tmux select-session -t 8'
alias s9='tmux select-session -t 9'
# select window
